...
public class Kochava : MonoBehaviour
{
	...
	public static class Tracker
	{
		...
		public static void Initialize()
		{
			...
			else if (instance == null)
			{
				...
				_dictionaryConfig.Add("versionExtension", "Unity 3.3.0");
				int num = 0;
				...
				try
				{
					...
					try
					{
						using (new AndroidJavaClass("com.unity3d.player.UnityPlayer"))
						{
							...
							androidTracker.CallStatic("ext", androidJavaObject8, "2018-09-14T20:45:20Z");
		...
		private static byte[] hexStringToByteArr(string hexString)
		{
			...
			{
				UnityEngine.Debug.Log("hexStringToByteArr() error: " + ex.Message);
				return null;
			}
		}
	...
	private const string sdkVersionNumber = "3.3.0";

	private const string sdkBuildDate = "2018-09-14T20:45:20Z";
