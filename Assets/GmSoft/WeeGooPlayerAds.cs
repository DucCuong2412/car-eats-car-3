...
public class WeeGooPlayerAds : Advertisement
{
    private static WeeGooPlayerAds _instance;

    public static WeeGooPlayerAds Instance { get { return _instance; } }
    ...
    private void Awake()
    {
    gameObject.name = "WeeGooAdManager";
