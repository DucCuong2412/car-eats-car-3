...
public class UICamera : MonoBehaviour
{
	...
	public static GetKeyStateFunc GetKeyDown = UnityEngine.Input.GetKeyDown;

	public static GetKeyStateFunc GetKeyUp = UnityEngine.Input.GetKeyUp;

	public static GetKeyStateFunc GetKey = UnityEngine.Input.GetKey;

	public static GetAxisFunc GetAxis = UnityEngine.Input.GetAxis;
	...
	public void ProcessMouse()
	{
		...
		if (flag2 || flag || mNextRaycast < RealTime.time)
		{
			...
			if (!Raycast(UnityEngine.Input.mousePosition))
			{
