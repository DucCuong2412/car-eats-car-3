...
public class tk2dSpriteAnimator : MonoBehaviour
{
	...
	public static bool g_Paused
	{
		get
		{
			return (globalState & State.Paused) != State.Init;
		}
		set
		{
	...
	public bool Paused
	{
		get
		{
			return (state & State.Paused) != State.Init;
		}
		set
		{
			if (value)
	...
	public bool Playing => (state & State.Playing) != State.Init;
	...
	{
		tk2dSpriteAnimationClip tk2dSpriteAnimationClip = (!library) ? null : library.GetClipByName(name);
		...
		{
			PlayFrom(tk2dSpriteAnimationClip, clipStartTime);
		}
	}
	...
	private void WarpClipToLocalTime(tk2dSpriteAnimationClip clip, float time)
	{
		...
		SetSprite(tk2dSpriteAnimationFrame.spriteCollection, tk2dSpriteAnimationFrame.spriteId);
		if (tk2dSpriteAnimationFrame.triggerEvent && AnimationEventTriggered != null)
		{
