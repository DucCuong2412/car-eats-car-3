	...
	internal class SnapshotManager
	{
		internal class OpenResponse : BaseReferenceHolder
		{
			...
			internal string ConflictId()
			{
				...
				return PInvokeUtilities.OutParamsToString((byte[] out_string, UIntPtr out_size) => GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_OpenResponse_GetConflictId(SelfPtr(), out_string, out_size));
			}
		...
		[CompilerGenerated]
		private static Func<IntPtr, OpenResponse> _003C_003Ef__mg_0024cache8;

		[CompilerGenerated]
		private static GooglePlayGames.Native.Cwrapper.SnapshotManager.OpenCallback _003C_003Ef__mg_0024cache9;

		[CompilerGenerated]
		private static Func<IntPtr, OpenResponse> _003C_003Ef__mg_0024cacheA;

		[CompilerGenerated]
		private static GooglePlayGames.Native.Cwrapper.SnapshotManager.OpenCallback _003C_003Ef__mg_0024cacheB;

		[CompilerGenerated]
		private static Func<IntPtr, ReadResponse> _003C_003Ef__mg_0024cacheC;

		[CompilerGenerated]
		private static GooglePlayGames.Native.Cwrapper.SnapshotManager.ReadCallback _003C_003Ef__mg_0024cacheD;
		...
		[AOT.MonoPInvokeCallback(typeof(GooglePlayGames.Native.Cwrapper.SnapshotManager.FetchAllCallback))]
		...
		[AOT.MonoPInvokeCallback(typeof(GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotSelectUICallback))]
		...
		[AOT.MonoPInvokeCallback(typeof(GooglePlayGames.Native.Cwrapper.SnapshotManager.OpenCallback))]
		...
		internal void Resolve(NativeSnapshotMetadata metadata, NativeSnapshotMetadataChange metadataChange, string conflictId, Action<OpenResponse> callback)
		{
			...
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_ResolveConflict(mServices.AsHandle(), conflictId, metadata.AsPointer(), metadataChange.AsPointer(), InternalOpenCallback, Callbacks.ToIntPtr(callback, OpenResponse.FromPointer));
		}
		...
		internal void Resolve(NativeSnapshotMetadata metadata, NativeSnapshotMetadataChange metadataChange, string conflictId, byte[] updatedData, Action<OpenResponse> callback)
		{
			...
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_ResolveConflict(mServices.AsHandle(), conflictId, metadata.AsPointer(), metadataChange.AsPointer(), updatedData, new UIntPtr((ulong)updatedData.Length), InternalOpenCallback, Callbacks.ToIntPtr(callback, OpenResponse.FromPointer));
		}

		[AOT.MonoPInvokeCallback(typeof(GooglePlayGames.Native.Cwrapper.SnapshotManager.CommitCallback))]
		...
		[AOT.MonoPInvokeCallback(typeof(GooglePlayGames.Native.Cwrapper.SnapshotManager.ReadCallback))]
