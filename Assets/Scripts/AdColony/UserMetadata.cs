	...
	public class UserMetadata
	{
		...
		public int Age
		{
			...
			set
			{
				if (value <= 0)
				{
					UnityEngine.Debug.Log("Tried to set user metadata age with an invalid value. Value will not be included.");
					return;
				}
				_age = value;
		...
		public string Gender
		{
			...
			set
			{
				if (value == null)
				{
					UnityEngine.Debug.Log("Tried to set user metadata gender with an invalid string. Value will not be included.");
					return;
				}
		...
		public string ZipCode
		{
			...
			set
			{
				if (value == null)
				{
					UnityEngine.Debug.Log("Tried to set user metadata zip code with an invalid string. Value will not be included.");
					return;
				}
		...
		public string MaritalStatus
		{
			...
			set
			{
				if (value == null)
				{
					UnityEngine.Debug.Log("Tried to set user metadata marital status with an invalid string. Value will not be included.");
					return;
				}
		...
		public string EducationLevel
		{
			...
			set
			{
				if (value == null)
				{
					UnityEngine.Debug.Log("Tried to set user metadata education level with an invalid string. Value will not be included.");
					return;
				}
