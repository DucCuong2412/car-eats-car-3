	...
	public class Ads : MonoBehaviour
	{
		...
		public static Ads SharedGameObject
		{
			get
			{
				...
				if (!_sharedGameObject)
				{
					...
					{
						UnityEngine.Debug.LogWarning(Constants.AdsMessageAlreadyInitialized);
					}
					else
					{
		...
		private static IAds SharedInstance
		{
			get
			{
				...
				if (ads == null)
				{
					UnityEngine.Debug.LogError(Constants.AdsMessageErrorInvalidImplementation);
				}
				return ads;
			}
		}
		...
		public static void Configure(string appId, AppOptions options, params string[] zoneIds)
		{
			...
			{
				UnityEngine.Debug.LogWarning(Constants.AdsMessageSDKUnavailable);
				return;
			}
		...
		public static void ShowAd(InterstitialAd ad)
		{
			if (IsInitialized())
			{
				...
				{
					UnityEngine.Debug.LogError(Constants.AdsMessageErrorNullAd);
				}
			}
		}
		...
		private static bool IsInitialized()
		{
			...
			if (!_initialized)
			{
				UnityEngine.Debug.LogError(Constants.AdsMessageNotInitialized);
				return false;
			}
			return true;
		}
		...
		public void _OnConfigure(string paramJson)
		{
			...
			if (arrayList == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnConfigure, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
		...
		public void _OnRequestInterstitial(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnRequestInterstitial, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			InterstitialAd adFromHashtable = GetAdFromHashtable(hashtable);
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnRequestInterstitial, " + ((paramJson != null) ? paramJson : "null"));
			}
			else if (Ads.OnRequestInterstitial != null)
			{
				...
				{
					UnityEngine.Debug.LogError(Constants.AdsMessageErrorUnableToRebuildAd);
				}
			}
		}
		...
		public void _OnRequestInterstitialFailed(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnRequestInterstitialFailed, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
		...
		public void _OnOpened(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnOpened, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			InterstitialAd adFromHashtable = GetAdFromHashtable(hashtable);
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnOpened, " + ((paramJson != null) ? paramJson : "null"));
			}
		...
		public void _OnClosed(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnClosed, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			InterstitialAd adFromHashtable = GetAdFromHashtable(hashtable);
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnClosed, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
		...
		public void _OnExpiring(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnExpiring, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			InterstitialAd adFromHashtable = GetAdFromHashtable(hashtable);
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnExpiring, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
		...
		public void _OnAudioStarted(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnAudioStarted, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			InterstitialAd adFromHashtable = GetAdFromHashtable(hashtable);
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnAudioStarted, " + ((paramJson != null) ? paramJson : "null"));
			}
		...
		public void _OnAudioStopped(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnAudioStopped, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			InterstitialAd adFromHashtable = GetAdFromHashtable(hashtable);
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnAudioStopped, " + ((paramJson != null) ? paramJson : "null"));
			}
		...
		public void _OnLeftApplication(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnLeftApplication, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			InterstitialAd adFromHashtable = GetAdFromHashtable(hashtable);
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnLeftApplication, " + ((paramJson != null) ? paramJson : "null"));
			}
		...
		public void _OnClicked(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnClicked, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			InterstitialAd adFromHashtable = GetAdFromHashtable(hashtable);
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnClicked, " + ((paramJson != null) ? paramJson : "null"));
			}
		...
		public void _OnIAPOpportunity(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnIAPOpportunity, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			...
			if (adFromHashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to create ad within _OnIAPOpportunity, " + ((paramJson != null) ? paramJson : "null"));
			}
		...
		public void _OnRewardGranted(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnRewardGranted, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			if (hashtable != null)
			{
		...
		public void _OnCustomMessageReceived(string paramJson)
		{
			...
			if (hashtable == null)
			{
				UnityEngine.Debug.LogError("Unable to parse parameters in _OnCustomMessageReceived, " + ((paramJson != null) ? paramJson : "null"));
				return;
			}
			if (hashtable != null)
			{
