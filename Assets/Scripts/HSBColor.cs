...
public struct HSBColor
{
	...
	public static void Test()
	{
		...
		UnityEngine.Debug.Log("red: " + hSBColor);
		hSBColor = new HSBColor(Color.green);
		UnityEngine.Debug.Log("green: " + hSBColor);
		hSBColor = new HSBColor(Color.blue);
		UnityEngine.Debug.Log("blue: " + hSBColor);
		hSBColor = new HSBColor(Color.grey);
		UnityEngine.Debug.Log("grey: " + hSBColor);
		hSBColor = new HSBColor(Color.white);
		UnityEngine.Debug.Log("white: " + hSBColor);
		hSBColor = new HSBColor(new Color(0.4f, 1f, 0.84f, 1f));
		UnityEngine.Debug.Log("0.4, 1f, 0.84: " + hSBColor);
		UnityEngine.Debug.Log("164,82,84   .... 0.643137f, 0.321568f, 0.329411f  :" + ToColor(new HSBColor(new Color(0.643137f, 0.321568f, 0.329411f))));
	}
}
