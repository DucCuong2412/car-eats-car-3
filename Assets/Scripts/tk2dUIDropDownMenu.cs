...
public class tk2dUIDropDownMenu : MonoBehaviour
{
	...
	public void UpdateList()
	{
		...
		{
			tk2dUIDropDownItem tk2dUIDropDownItem = dropDownItems[j];
			...
			{
				localPosition.y = 0f - height - (float)j * tk2dUIDropDownItem.height;
			}
			tk2dUIDropDownItem.transform.localPosition = localPosition;
			if (tk2dUIDropDownItem.label != null)
			{
				tk2dUIDropDownItem.LabelText = itemList[j];
			}
	...
	private void ExpandList()
	{
		...
		tk2dUIDropDownItem tk2dUIDropDownItem = dropDownItems[index];
