...
public class tk2dSpriteCollectionData : MonoBehaviour
{
	...
	private void Init()
	{
		...
		if (needMaterialInstance)
		{
			...
			{
				tk2dSpriteDefinition tk2dSpriteDefinition = spriteDefinitions[l];
				tk2dSpriteDefinition.materialInst = materialInsts[tk2dSpriteDefinition.materialId];
			}
		}
		else
		{
			...
			{
				tk2dSpriteDefinition tk2dSpriteDefinition2 = spriteDefinitions[n];
